...
RSpec.describe AddressBook do  
  ...
  describe "#import_from_csv" do
    ...
    it "imports the 1st entry" do
      ...
      check_entry(entry, "Alec", "555-555-3667", "alec@blocmail.com")
    end
     
    it "imports the 2nd entry" do
      book.import_from_csv("entries_2.csv")
      entry = book.entries[1]
      check_entry(entry, "Jane", "555-555-4855", "jane@blocmail.com")
    end
     
    it "imports the 3rd entry" do
      book.import_from_csv("entries_2.csv")
      entry = book.entries[2]
      check_entry(entry, "Sam", "555-555-5416", "sam@blocmail.com")
    end
  end
  ...
  describe "#demolish" do
    it "should delete all entries in the addressbook" do
